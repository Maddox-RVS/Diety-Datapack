execute unless entity @s[nbt={Inventory:[{id:"minecraft:netherite_ingot"},{id:"minecraft:rabbit_foot"}]}] run tellraw @s[team=!Motion] {"text":"YOU DO NOT HAVE THE CORRECT MATERIALS","color":"red"}
tellraw @s[team=Motion] {"text":"YOU ARE ALREADY THE MOTION DEITY","color":"red"}
