...
execute unless entity @a[team=End] run execute unless entity @s[nbt={Inventory:[{id:"minecraft:netherite_ingot"},{id:"minecraft:ender_eye"}]}] run tellraw @s {"text":"YOU DO NOT HAVE THE CORRECT MATERIALS","color":"red"}
execute if entity @s[nbt={Inventory:[{id:"minecraft:netherite_ingot"},{id:"minecraft:ender_eye"}]}] run tellraw @s[team=End] {"text":"YOU ARE ALREADY END DEITY","color":"red"}
...
execute unless entity @a[team=End] run execute if entity @s[nbt={Inventory:[{id:"minecraft:netherite_ingot"},{id:"minecraft:ender_eye"}]}] run clear @s[team=Changing] minecraft:netherite_ingot 1
