...
execute unless entity @a[team=Animals] run execute unless entity @s[nbt={Inventory:[{id:"minecraft:netherite_scrap"},{id:"minecraft:leather"}]}] run tellraw @s[team=!Animals] {"text":"YOU DO NOT HAVE THE CORRECT MATERIALS","color":"red"}
tellraw @s[team=Animals] {"text":"YOU ARE ALREADY THE ANIMAL DEITY","color":"red"}
